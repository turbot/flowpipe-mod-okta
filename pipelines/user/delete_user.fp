pipeline "delete_user" {
  title       = "Delete User"
  description = "Delete a user by ID. Deletes a user permanently. This operation can only be performed on users that have a DEPROVISIONED status. This action cannot be recovered."
